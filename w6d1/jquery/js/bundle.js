...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  $('#easel').append( "<p id='new'>new paragraph</p>" );
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $(".row").on("click", "li", function (event) {
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  let random = window._randomColorString();
  $('li').css("background-color", random);
};
...
View.prototype.exercise7 = function(){
  ...
  $(".row").on("mouseover", "li", function (event) {
